                ...
                'shopify' => [
                    ...
                    'required_fields' => [
                        ...
                        'access_token' => [
                            ...
                            'type' => 'password',
                            'required' => true,
                            'helper' => 'Create a custom app in your Shopify admin to get this token',
                        ],
                        'api_secret' => [
                            'label' => 'API Secret Key',
                            'type' => 'password',
                            'required' => false,
                            'helper' => 'Required for webhook verification (optional if not using webhooks)',
                        ],
                        'location_id' => [
                            'label' => 'Location ID',
                            'type' => 'text',
                            'required' => false,
                            'helper' => 'Shopify location ID for inventory updates (find in Admin > Settings > Locations)',
                        ],
                        'api_version' => [
                            'label' => 'API Version',
                            'type' => 'text',
                            ...
                            'required' => false,
                            'placeholder' => '2025-10',
                            'helper' => 'Shopify API version to use (default: 2025-10)',
                        ],
                    ],
