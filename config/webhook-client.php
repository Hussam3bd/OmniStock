...
return [
    'configs' => [
        ...
        [
            ...
            'signature_validator' => \App\Services\Integrations\Webhooks\TrendyolSignatureValidator::class,
            'webhook_profile' => \App\Services\Integrations\Webhooks\TrendyolWebhookProfile::class,
            'webhook_response' => \Spatie\WebhookClient\WebhookResponse\DefaultRespondsTo::class,
            'webhook_model' => \Spatie\WebhookClient\Models\WebhookCall::class,
            'store_headers' => ['*'],
